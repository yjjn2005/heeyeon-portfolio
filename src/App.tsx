...
// CONSTANTS
// ──────────────────────────────────────────────────────────────────────────────
const LOCAL_KEY = 'heeyeon_portfolio_v8_local';
const APP_ID    = import.meta.env.VITE_FIREBASE_APP_ID || 'portfolio-default';

const INITIAL_STOCKS: Stock[] = [
  // ── 한국투자증권 (ISA중개형) ──
  {id:1,   n:"예수금(현금)",                      c:"-",      yt:"",          t:"예금/현금", sh:0,    bp:47887317,  inv:47887317, base:47887317, cur:"KRW", ow:"김희연", ac:"ISA",     br:"한국투자증권"},
  // ── 한국투자증권 (해외위탁) ──
  {id:2,   n:"엔비디아",                          c:"NVDA",   yt:"NVDA",      t:"미국주식",  sh:440,  bp:108.64,    inv:72336481, base:217.10,  cur:"USD", ow:"김희연", ac:"해외위탁", br:"한국투자증권"},
  {id:3,   n:"STATE STREET SPDR(SPVM)",          c:"SPVM",   yt:"SPVM",      t:"미국ETF",   sh:7,    bp:48.54,     inv:514189,   base:88.26,   cur:"USD", ow:"김희연", ac:"해외위탁", br:"한국투자증권"},
  {id:4,   n:"외화(USD)",                         c:"-",      yt:"",          t:"예금/현금", sh:0,    bp:76285,     inv:76285,    base:76285,   cur:"KRW", ow:"김희연", ac:"해외위탁", br:"한국투자증권"},
  // ── 한국투자증권 (IRP) ──
  {id:5,   n:"TIGER 코리아배당다우존스",            c:"439870", yt:"439870.KS", t:"국내ETF",  sh:3,    bp:12470,     inv:37410,    base:16535,   cur:"KRW", ow:"김희연", ac:"IRP",     br:"한국투자증권"},
  {id:6,   n:"TIGER 미국나스닥100",               c:"133690", yt:"133690.KS", t:"국내ETF",  sh:34,   bp:44425,     inv:1510450,  base:198200,  cur:"KRW", ow:"김희연", ac:"IRP",     br:"한국투자증권"},
  {id:7,   n:"PLUS 고배당주",                     c:"406390", yt:"406390.KS", t:"국내ETF",  sh:279,  bp:13970,     inv:3897630,  base:27115,   cur:"KRW", ow:"김희연", ac:"IRP",     br:"한국투자증권"},
  {id:8,   n:"ACE 미국S&P500",                   c:"360200", yt:"360200.KS", t:"국내ETF",  sh:244,  bp:12185,     inv:2973240,  base:28385,   cur:"KRW", ow:"김희연", ac:"IRP",     br:"한국투자증권"},
  {id:9,   n:"ACE 미국나스닥100",                 c:"367380", yt:"367380.KS", t:"국내ETF",  sh:193,  bp:11710,     inv:2260060,  base:34075,   cur:"KRW", ow:"김희연", ac:"IRP",     br:"한국투자증권"},
  {id:10,  n:"TIGER 미국배당다우존스",             c:"458730", yt:"458730.KS", t:"국내ETF",  sh:280,  bp:11877,     inv:3325800,  base:15775,   cur:"KRW", ow:"김희연", ac:"IRP",     br:"한국투자증권"},
  // ── 한국투자증권 (국내주식·위탁) ──
  {id:11,  n:"LS ELECTRIC",                      c:"010120", yt:"010120.KS", t:"국내주식", sh:280,  bp:91710,     inv:25679000, base:282500,  cur:"KRW", ow:"김희연", ac:"위탁",    br:"한국투자증권"},
  {id:12,  n:"두산에너빌리티",                     c:"034020", yt:"034020.KS", t:"국내주식", sh:788,  bp:80600,     inv:63512800, base:113000,  cur:"KRW", ow:"김희연", ac:"위탁",    br:"한국투자증권"},
  {id:13,  n:"HD현대중공업",                      c:"329180", yt:"329180.KS", t:"국내주식", sh:116,  bp:479500,    inv:55622000, base:756000,  cur:"KRW", ow:"김희연", ac:"위탁",    br:"한국투자증권"},
  // ── 한국투자증권 (개인연금) ──
  {id:14,  n:"TIGER 코리아배당다우존스",            c:"439870", yt:"439870.KS", t:"국내ETF",  sh:1784, bp:13185,     inv:23522040, base:16535,   cur:"KRW", ow:"김희연", ac:"연금",    br:"한국투자증권"},
  // ── 한국투자증권 (주식계좌·위탁) ──
  ...
  {id:26,  n:"레인보우로보틱스",                    c:"277810", yt:"277810.KQ", t:"국내주식", sh:79,   bp:376500,    inv:29743500, base:741000,  cur:"KRW", ow:"김희연", ac:"위탁",    br:"유진투자증권"},
];
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-emerald-500/10 to-blue-500/10 px-3 py-1 text-[11px] font-extrabold tracking-widest text-emerald-400 border border-emerald-500/20">
                <PieChart size={12} /> {ownerName || '김희연'} PREMIUM ASSETS
              </div>
...
const SettingsView = ({
  ...
  const handleRestoreDemo = () => {
    if (!window.confirm('데모 데이터(김희연 포트폴리오)를 복원하시겠습니까?')) return;
...
const StockModal = ({
  ...
  useEffect(() => {
    ...
    setForm(editingStock || { n:'', c:'', yt:'', t:'국내주식', cur:'KRW', ow:'김희연', ac:'위탁', br:'한국투자증권', sh:0, bp:0, base:0, inv:0 });
...
export default function App() {
  ...
  const [ownerName, setOwnerName] = useState(() => localStorage.getItem('heeyeon_ow_portfolio_name') || '김희연');
  ...
  const saveOwnerName = () => { localStorage.setItem('heeyeon_ow_portfolio_name', ownerName); showToast(`소유자 [${ownerName}] 저장 완료`); };
  ...
  useEffect(() => {
    if (!user || !db) return;
    const stocksRef   = collection(db!, 'artifacts', APP_ID, 'public', 'data', 'stocks_heeyeon_v5');
    const settingsRef = doc(db!, 'artifacts', APP_ID, 'public', 'data', 'settings_heeyeon_v5', 'global');
  ...
  const saveStockToCloud = async (stock: Stock) => {
    ...
    if (user && db) await setDoc(doc(db!, 'artifacts', APP_ID, 'public', 'data', 'stocks_heeyeon_v5', String(stock.id)), stock);
  };
  ...
  const deleteStockFromCloud = async (id: number) => {
    ...
    setStocks(newStocks);
    localStorage.setItem(LOCAL_KEY, JSON.stringify({ stocks: newStocks, prices, rates, lastUpdated }));
    if (user && db) await deleteDoc(doc(db!, 'artifacts', APP_ID, 'public', 'data', 'stocks_heeyeon_v5', String(id)));
  };
  ...
  const saveSettingsToCloud = async (newPrices: Prices, newRates: Rates, newTs: string | null) => {
    ...
    if (user && db) {
      const ref = doc(db!, 'artifacts', APP_ID, 'public', 'data', 'settings_heeyeon_v5', 'global');
    ...
    reader.onload = async (ev) => {
      try {
        ...
        if (user && db && data.stocks) {
          const batch = writeBatch(db!);
          const ref = collection(db!, 'artifacts', APP_ID, 'public', 'data', 'stocks_heeyeon_v5');
